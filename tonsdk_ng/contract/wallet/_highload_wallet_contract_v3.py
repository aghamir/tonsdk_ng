...
class HighloadWalletV3Contract(WalletContract):
    ...
    # async def get_wallet_id(self):
    #     id = await self.provider.call2(
    #         self.address.to_string(), "get_subwallet_id"
    #     )
    #     return id.to_number()
    #
    # async def get_public_key(self):
    #     return self.provider.call2(
    #         self.address.to_string(), "get_public_key")
    #
    # async def get_last_clean_time(self):
    #     id = await self.provider.call2(
    #         self.address.to_string(), "get_last_clean_time"
    #     )
    #     return id.to_number()
    #
    # async def get_timeout(self):
    #     id = await self.provider.call2(
    #         self.address.to_string(), "get_timeout")
    #     return id.to_number()
    #
    # async def is_processed(self, query_id, need_clean):
    #     result = await self.provider.call2(
    #         self.address.to_string(),
    #         "processed?",
    #         [
    #             ["num", str(query_id.get_query_id())],
    #             ["num", "-1" if need_clean else "0"],
    #         ],
    #     )
