...
class Address:
    ...
    @classmethod
    def from_any(cls, val: Self | Cell | str) -> Self:
        address: Self | None = None

        match val:
            case str():
                address = cls.from_string(val)
            case Address():
                address = cls.from_address(cast(Self, val))
            case Cell():
    ...
    @classmethod
    def from_address(cls, addr: Self) -> Self:
        return cls(
            wc=addr.wc,
    ...
    @classmethod
    def from_cell(cls, cell: Cell) -> Self | None:
