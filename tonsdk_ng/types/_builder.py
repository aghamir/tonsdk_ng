...
class Builder:
    ...
    def store_cell(self, src: Cell) -> Self:
        self.bits.write_bit_string(src.bits)
        self.refs += src.refs
        return self

    def store_ref(self, src: Cell) -> Self:
        self.refs.append(src)
        return self

    def store_maybe_ref(self, src: Cell | None) -> Self:
        if src:
    ...
    def store_bit(self, value: int) -> Self:
        self.bits.write_bit(value)
        return self

    def store_bit_array(self, value: bytes | bytearray) -> Self:
        self.bits.write_bit_array(value)
        return self

    def store_uint(self, value: int, bit_length: int) -> Self:
        self.bits.write_uint(value, bit_length)
        return self

    def store_uint8(self, value: int) -> Self:
        self.bits.write_uint8(value)
        return self

    def store_int(self, value: int, bit_length: int) -> Self:
        self.bits.write_int(value, bit_length)
        return self

    def store_string(self, value: str) -> Self:
        self.bits.write_string(value)
        return self

    def store_bytes(self, value: bytes) -> Self:
        self.bits.write_bytes(value)
        return self

    def store_bit_string(self, value: BitString) -> Self:
        self.bits.write_bit_string(value)
        return self

    def store_address(self, value: Address) -> Self:
        self.bits.write_address(value)
        return self

    def store_grams(self, value: int) -> Self:
        self.bits.write_grams(value)
        return self

    def store_coins(self, value: int) -> Self:
